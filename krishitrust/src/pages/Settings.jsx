            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Receive shipment and business alerts</p>
                </div>
                <button 
              ...
              <div className="flex items-center justify-between border-t border-white/5 pt-4">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Automatically sync sensor telemetry data</p>
                </div>
                <button 
                  onClick={() => toggleSetting('autoSync')}
                  className={`w-12 h-6 rounded-full transition-all duration-300 ${
                    settings.autoSync ? 'bg-green-500' : 'bg-gray-600'
                  }`}
                >
                  <div className={`w-4 h-4 bg-white rounded-full transition-all duration-300 transform ${
              ...
              <div className="flex items-center justify-between border-t border-white/5 pt-4">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Display theme preference</p>
                </div>
                <button 
        ...
        {activeTab === 'business' && (
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white font-medium">Business Alerts</p>
                  <p className="text-gray-400 text-sm">Get notified about profile changes and milestones</p>
                </div>
                <button 
                  onClick={() => toggleSetting('businessAlerts')}
                  className={`w-12 h-6 rounded-full transition-all duration-300 ${
                    settings.businessAlerts ? 'bg-green-500' : 'bg-gray-600'
                  }`}
                >
                  <div className={`w-4 h-4 bg-white rounded-full transition-all duration-300 transform ${
                    settings.businessAlerts ? 'translate-x-7' : 'translate-x-1'
                  }`} />
                </button>
              </div>
              <div className="flex items-center justify-between border-t border-white/5 pt-4">
                <div>
                  <p className="text-white font-medium">Profile Optimization</p>
                  <p className="text-gray-400 text-sm">Automatically suggest business improvements</p>
                </div>
                <button 
                  onClick={() => toggleSetting('profileOptimization')}
                  className={`w-12 h-6 rounded-full transition-all duration-300 ${
                    settings.profileOptimization ? 'bg-green-500' : 'bg-gray-600'
                  }`}
                >
                  <div className={`w-4 h-4 bg-white rounded-full transition-all duration-300 transform ${
                    settings.profileOptimization ? 'translate-x-7' : 'translate-x-1'
                  }`} />
                </button>
              </div>
              <div className="flex items-center justify-between border-t border-white/5 pt-4">
                <div>
                  <p className="text-white font-medium">Finance Readiness Tracking</p>
                  <p className="text-gray-400 text-sm">Monitor and improve finance readiness score</p>
                </div>
                <button 
                  onClick={() => toggleSetting('financeReadinessTracking')}
                  className={`w-12 h-6 rounded-full transition-all duration-300 ${
                    settings.financeReadinessTracking ? 'bg-green-500' : 'bg-gray-600'
                  }`}
                >
                  <div className={`w-4 h-4 bg-white rounded-full transition-all duration-300 transform ${
                    settings.financeReadinessTracking ? 'translate-x-7' : 'translate-x-1'
                  }`} />
                </button>
              </div>
              <div className="border-t border-white/5 pt-4">
                <div className="mb-2">
                  <p className="text-white font-medium">Readiness Threshold</p>
                  <p className="text-gray-400 text-sm">Score above this threshold triggers readiness alerts</p>
                </div>
                <div className="flex items-center gap-4">
                  <input 
                    ...
                    onChange={(e) => updateThreshold('readinessThreshold', e.target.value)}
              ...
              <div className="border-t border-white/5 pt-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-white font-medium">Finance Profile Visibility</p>
                    <p className="text-gray-400 text-sm">Control who can view your finance readiness profile</p>
                  </div>
                  <select 
                    value={settings.financeProfileVisibility}
                    onChange={(e) => setSettings(prev => ({ ...prev, financeProfileVisibility: e.target.value }))}
                    className="bg-[#0d1117] border border-white/10 rounded-lg px-3 py-1.5 text-white text-sm focus:outline-none focus:border-green-500/50"
                  >
                  ...
                  {corridors.map((corridor) => (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-300 ${
                        settings.preferredCorridors.includes(corridor.id)
                          ? `bg-green-600 text-white shadow-lg shadow-green-500/20`
                          : 'bg-[#0d1117] text-gray-400 hover:text-white hover:bg-white/10 border border-white/5'
                      }`}
                    >
                      {corridor.label}
                      <span className={`ml-1.5 text-xs ${
                        corridor.risk === 'Critical' ? 'text-red-400' :
                        corridor.risk === 'High' ? 'text-orange-400' :
                        corridor.risk === 'Medium' ? 'text-yellow-400' :
                        'text-green-400'
                      }`}>
                        ({corridor.risk})
                      </span>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Monitor active shipment positions in real-time</p>
                </div>
                <button 
                  onClick={() => toggleSetting('shipmentTracking')}
                  className={`w-12 h-6 rounded-full transition-all duration-300 ${
                    settings.shipmentTracking ? 'bg-green-500' : 'bg-gray-600'
                  }`}
                >
                  <div className={`w-4 h-4 bg-white rounded-full transition-all duration-300 transform ${
                    settings.shipmentTracking ? 'translate-x-7' : 'translate-x-1'
                  }`} />
                </button>
              </div>
              <div className="flex items-center justify-between border-t border-white/5 pt-4">
                <div>
                  <p className="text-white font-medium">Cargo Monitoring</p>
                  <p className="text-gray-400 text-sm">Track produce conditions (temp, humidity, shock)</p>
                </div>
                <button 
                  onClick={() => toggleSetting('cargoMonitoring')}
                  className={`w-12 h-6 rounded-full transition-all duration-300 ${
                    settings.cargoMonitoring ? 'bg-green-500' : 'bg-gray-600'
                  }`}
                >
                  <div className={`w-4 h-4 bg-white rounded-full transition-all duration-300 transform ${
                    settings.cargoMonitoring ? 'translate-x-7' : 'translate-x-1'
                  }`} />
                </button>
              </div>
              <div className="border-t border-white/5 pt-4">
                <div className="mb-2">
                  <p className="text-white font-medium">Shock Alert Threshold</p>
                  <p className="text-gray-400 text-sm">Alert when handling shock exceeds this G-force value</p>
                </div>
                <div className="flex items-center gap-4">
                  <input 
                    type="range"
                    ...
                    max="5"
                    step="0.1"
                    value={settings.shockAlertThreshold}
                    onChange={(e) => updateThreshold('shockAlertThreshold', e.target.value)}
              ...
              <div className="border-t border-white/5 pt-4">
                <div className="mb-2">
                  <p className="text-white font-medium">Temperature Alert Threshold</p>
                  <p className="text-gray-400 text-sm">Alert when produce temp exceeds this value</p>
                </div>
                <div className="flex items-center gap-4">
                  <input 
                    type="range"
                    ...
                    onChange={(e) => updateThreshold('tempAlertThreshold', e.target.value)}
              ...
              <div className="border-t border-white/5 pt-4">
                <div className="mb-2">
                  <p className="text-white font-medium">Humidity Alert Threshold</p>
                  <p className="text-gray-400 text-sm">Alert when produce humidity exceeds this value</p>
                </div>
                <div className="flex items-center gap-4">
                  <input 
                    type="range"
                    ...
                    onChange={(e) => updateThreshold('humidityAlertThreshold', e.target.value)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-[#0d1117] rounded-xl p-4 border border-white/5 hover:border-green-500/30 transition-all duration-300">
                <p className="text-white font-medium flex items-center gap-2">
                  <span>📡</span> GPS Module
                </p>
                <div className="mt-2 space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Protocol</span>
                    <span className="text-gray-200">NMEA 0183</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Baud Rate</span>
                    <span className="text-gray-200">9600</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-200">±2.5m</span>
                  </div>
                </div>
              </div>
              <div className="bg-[#0d1117] rounded-xl p-4 border border-white/5 hover:border-green-500/30 transition-all duration-300">
                <p className="text-white font-medium flex items-center gap-2">
                  <span>📊</span> MPU6050 IMU
                </p>
                <div className="mt-2 space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Range</span>
                    <span className="text-gray-200">±8G</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Sampling</span>
                    <span className="text-gray-200">100 Hz</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="bg-[#0d1117] rounded-xl p-4 border border-white/5 hover:border-green-500/30 transition-all duration-300">
                <p className="text-white font-medium flex items-center gap-2">
                  <span>🌡️</span> Environmental Sensor
                </p>
                <div className="mt-2 space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Temp Range</span>
                    <span className="text-gray-200">-40°C to 85°C</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Accuracy</span>
                    <span className="text-gray-200">±0.5°C</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Status</span>
              ...
              <div className="bg-[#0d1117] rounded-xl p-4 border border-white/5 hover:border-green-500/30 transition-all duration-300">
                <p className="text-white font-medium flex items-center gap-2">
                  <span>⚡</span> ESP32 Controller
                </p>
                <div className="mt-2 space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Port</span>
                    <span className="text-gray-200">COM3</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Baud Rate</span>
                    <span className="text-gray-200">115200</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Status</span>
                    <span className="text-green-400">Connected</span>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between bg-[#0d1117] rounded-xl p-4 border border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-medium">Handling Risk AI</p>
                    <p className="text-gray-400 text-sm">Predictive handling risk scoring engine</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between bg-[#0d1117] rounded-xl p-4 border border-white/5">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">💰</span>
                  <div>
                    <p className="text-white font-medium">Finance Readiness Engine</p>
                    <p className="text-gray-400 text-sm">Business profile & finance readiness analysis</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
              ...
              <div className="flex items-center justify-between bg-[#0d1117] rounded-xl p-4 border border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-medium">Map Services</p>
                    <p className="text-gray-400 text-sm">OpenStreetMap / Satellite</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
              ...
              <div className="flex items-center justify-between bg-[#0d1117] rounded-xl p-4 border border-white/5">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">📱</span>
                  <div>
                    <p className="text-white font-medium">SMS Gateway</p>
                    <p className="text-gray-400 text-sm">Alert notifications to farmers and transporters</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
              ...
              <div className="border-t border-white/5 pt-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Automatically generate business intelligence reports</p>
                  </div>
                  <button 
                    onClick={() => toggleSetting('autoReportGeneration')}
                    className={`w-12 h-6 rounded-full transition-all duration-300 ${
                      settings.autoReportGeneration ? 'bg-green-500' : 'bg-gray-600'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full transition-all duration-300 transform ${
                      settings.autoReportGeneration ? 'translate-x-7' : 'translate-x-1'
                    }`} />
                  </button>
                </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-3">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white text-sm">Hardware</span>
          </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white text-sm">Data Points</span>
          </div>
